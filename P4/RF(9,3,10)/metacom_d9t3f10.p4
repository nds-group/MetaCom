    ...
    inout ingress_intrinsic_metadata_for_tm_t        ig_tm_md)
{
    ...
    action SetCode_f0(bit<41> code0, bit<35> code1, bit<46> code2) {
        meta.cw_t0[217:177] = code0;
        meta.cw_t1[195:161] = code1;
        meta.cw_t2[220:175] = code2;
    }
    action SetCode_f1(bit<29> code0, bit<45> code1, bit<36> code2) {
        meta.cw_t0[176:148] = code0;
        meta.cw_t1[160:116] = code1;
        meta.cw_t2[174:139] = code2;
    }
    action SetCode_f2(bit<58> code0, bit<45> code1, bit<51> code2) {
        meta.cw_t0[147:90] = code0;
        meta.cw_t1[115:71] = code1;
        meta.cw_t2[138:88] = code2;
    }
    action SetCode_f3(bit<22> code0, bit<14> code1, bit<21> code2) {
        meta.cw_t0[89:68] = code0;
        meta.cw_t1[70:57] = code1;
        meta.cw_t2[87:67] = code2;
    }
    action SetCode_f4(bit<15> code0, bit<8> code1, bit<14> code2) {
        meta.cw_t0[67:53] = code0;
        meta.cw_t1[56:49] = code1;
        meta.cw_t2[66:53] = code2;
    }
    action SetCode_f5(bit<12> code0, bit<10> code1, bit<12> code2) {
        meta.cw_t0[52:41] = code0;
        meta.cw_t1[48:39] = code1;
        meta.cw_t2[52:41]  = code2;
    }
    action SetCode_f6(bit<7> code0, bit<3> code1, bit<6> code2) {
        meta.cw_t0[40:34] = code0;
        meta.cw_t1[38:36] = code1;
        meta.cw_t2[40:35]  = code2;
    }
    action SetCode_f7(bit<5> code0, bit<4> code1, bit<4> code2) {
        meta.cw_t0[33:29] = code0;
        meta.cw_t1[35:32] = code1;
        meta.cw_t2[34:31] = code2;
    }
    action SetCode_f8(bit<23> code0, bit<28> code1, bit<24> code2) {
        meta.cw_t0[28:6] = code0;
        meta.cw_t1[31:4] = code1;
        meta.cw_t2[30:7]  = code2;
    }
    action SetCode_f9(bit<6> code0, bit<4> code1, bit<7> code2) {
        meta.cw_t0[5:0] = code0;
        meta.cw_t1[3:0] = code1;
        meta.cw_t2[6:0]  = code2;
    }
    ...
    table tbl_f9{
	    key = {meta.udp_len: range @name("f9");}
	    actions = {@defaultonly nop; SetCode_f9;}
	    size = 32;
        const default_action = nop();
	}
