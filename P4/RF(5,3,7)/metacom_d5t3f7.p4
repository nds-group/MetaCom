    ...
    inout ingress_intrinsic_metadata_for_tm_t        ig_tm_md)
{
    ...
    action SetCode_f0(bit<3> code0, bit<7> code1, bit<2> code2) {
        meta.cw_t0[30:28] = code0;
        meta.cw_t1[29:23] = code1;
        meta.cw_t2[29:28] = code2;
    }
    action SetCode_f1(bit<8> code0, bit<5> code1, bit<5> code2) {
        meta.cw_t0[27:20] = code0;
        meta.cw_t1[22:18] = code1;
        meta.cw_t2[27:23] = code2;
    }
    action SetCode_f2(bit<10> code0, bit<3> code1, bit<9> code2) {
        meta.cw_t0[19:10] = code0;
        meta.cw_t1[17:15] = code1;
        meta.cw_t2[22:14] = code2;
    }
    action SetCode_f3(bit<4> code0, bit<4> code1, bit<9> code2) {
        meta.cw_t0[9:6] = code0;
        meta.cw_t1[14:11] = code1;
        meta.cw_t2[13:5] = code2;
    }
    action SetCode_f4(bit<3> code0, bit<5> code1, bit<2> code2) {
        meta.cw_t0[5:3] = code0;
        meta.cw_t1[10:6] = code1;
        meta.cw_t2[4:3] = code2;
    }
    action SetCode_f5(bit<1> code0, bit<3> code2) {
        meta.cw_t0[2:2] = code0;
        //meta.cw_t1[11:7] = code1;
        meta.cw_t2[2:0]  = code2;
    }
    action SetCode_f6(bit<2> code0, bit<6> code1) {
        meta.cw_t0[1:0] = code0;
        meta.cw_t1[5:0] = code1;
        //meta.cw_t2[1:0]  = code2;
    }
	...
	table tbl_f1{
        key = {meta.hdr_dstport: range @name("f1");}
	    actions = {@defaultonly nop; SetCode_f1;}
	    size = 64;
        const default_action = nop();
	}
	table tbl_f2{
	    key = {meta.tcp_window_size: range @name("f2");}
